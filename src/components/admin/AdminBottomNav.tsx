...
export function AdminBottomNav({ pathname }: { pathname: string }) {
  return (
    <nav className="fixed inset-x-0 bottom-3 z-40 mx-auto w-[min(398px,calc(100%-24px))] rounded-[28px] border border-white/80 bg-[#2f2a25]/94 px-2 py-2 shadow-xl shadow-stone-500/25 backdrop-blur md:hidden" aria-label="管理者ナビゲーション">
